...
import 'package:filezy/buttomNav.dart';
            ...
            child: Padding(
              ...
              child: Column(
                  children: [
                    ...
                    Files(size: size,
                    icon: Options(size: size,
                      couleur: const Color(0xFFecffee),
                      image: Image.asset("assets/icons/musical-note.png",
                        width: 40,
                        height: 40,),
                      ),
                    ...
                    Files(size: size,
                      icon:  Options(size: size,
                        ...
                        image: Image.asset("assets/icons/video-marketing.png",
                          width: 40,
                          height: 40,),
                      ),
    ...
    return Row(
      ...
      children: [
        ...
        Options(size: size,
          ...
          image: Image.asset("assets/icons/photo.png",
            width: 50,
            height: 50,),
          label: "Photos",),
        Options(size: size,
